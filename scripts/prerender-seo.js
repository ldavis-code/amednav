...
const pages = [
  ...
  },
  {
    ...
    ogDescription: 'Terms and Conditions governing the use of AMedNav.',
  },
  {
    route: '/privacy',
  ...
  {
    route: '/accessibility',
    title: 'Accessibility Statement | AMedNav™',
    description: 'Our commitment to making AMedNav accessible to all users, including those with disabilities.',
    ogTitle: 'Accessibility Statement - AMedNav™',
