        ...
        <article className="max-w-5xl mx-auto space-y-12 pb-12">
            ...
            <header className="text-center py-8 md:py-12">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <Link
                        to="/pilot"
                        className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white hover:bg-slate-50 text-plum-700 font-bold rounded-xl shadow-sm border-2 border-plum-200 hover:border-plum-300 transition"
                    >
                        View Pilot Program
            ...
            {/* Cost Impact Stats */}
            <section className="bg-gradient-to-br from-plum-800 to-teal-900 rounded-2xl p-8 md:p-10">
                <h2 className="text-2xl font-bold text-white mb-2 text-center">The Cost of Medication Non-Adherence</h2>
                <p className="text-plum-200 text-center mb-8 max-w-2xl mx-auto">
                ...
                <div className="grid md:grid-cols-3 gap-6">
                    {costImpact.map((item, index) => (
                        <div key={index} className="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-center border border-white/20">
                            ...
                            <p className="text-plum-100 text-sm leading-relaxed">{item.label}</p>
                        </div>
                    ))}
                </div>
                <p className="text-plum-300 text-xs text-center mt-6">
                ...
                <div className="grid md:grid-cols-3 gap-6">
                    {integrationFeatures.map((feature, index) => (
                        <div key={index} className="bg-white p-6 rounded-xl border border-slate-200">
                            <div className="w-10 h-10 bg-plum-100 text-plum-600 rounded-lg flex items-center justify-center mb-4" aria-hidden="true">
            ...
            {/* ROI Case */}
            <section className="bg-gradient-to-br from-plum-50 to-teal-50 border-2 border-plum-200 rounded-2xl p-8">
                <div className="flex items-center gap-3 mb-4">
                    <DollarSign size={24} className="text-plum-700" aria-hidden="true" />
            ...
            <section className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 md:p-10">
                ...
                <div className="grid md:grid-cols-4 gap-6">
                    ...
                    <div className="text-center">
                        <div className="w-12 h-12 bg-plum-700 text-white rounded-full flex items-center justify-center mx-auto mb-4 font-bold text-xl">4</div>
            ...
            <section className="bg-slate-900 rounded-2xl p-8 md:p-10 text-white">
                <div className="flex items-center gap-3 mb-6">
                    <ShieldCheck size={24} className="text-plum-400" aria-hidden="true" />
                    <h2 className="text-2xl font-bold">Compliance & Security</h2>
                </div>
                <div className="grid md:grid-cols-2 gap-6">
                    <div>
                        <h3 className="font-bold text-plum-400 mb-2">HIPAA Compliance</h3>
                        <ul className="space-y-2 text-slate-300 text-sm">
                            <li className="flex items-start gap-2">
                                <CheckCircle size={16} className="text-plum-400 flex-shrink-0 mt-0.5" aria-hidden="true" />
                    ...
                    <div>
                        <h3 className="font-bold text-plum-400 mb-2">CMS & Regulatory</h3>
                        <ul className="space-y-2 text-slate-300 text-sm">
                            <li className="flex items-start gap-2">
                                <CheckCircle size={16} className="text-plum-400 flex-shrink-0 mt-0.5" aria-hidden="true" />
            ...
            <section className="bg-white border-2 border-plum-200 rounded-2xl p-8 text-center">
                <div className="flex items-center justify-center gap-2 mb-4">
                    <HeartPulse size={24} className="text-plum-700" aria-hidden="true" />
