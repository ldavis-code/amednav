        ...
        <article className="max-w-4xl mx-auto space-y-8 pb-12">
            <header className="text-center py-8">
                <div className="inline-flex items-center justify-center w-16 h-16 bg-plum-100 rounded-full mb-4">
                    <Shield size={32} className="text-plum-700" aria-hidden="true" />
                </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 md:p-8 space-y-8">
                <section>
                    <p className="text-slate-700 leading-relaxed">
                        AMedNav LLC ("we," "us," or "our") operates the AMedNav website (the "Website"). This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our Website.
                    </p>
                ...
                <section>
                    ...
                    <p className="text-slate-700 leading-relaxed mt-4 font-semibold bg-plum-50 border border-plum-200 rounded-lg p-4">
