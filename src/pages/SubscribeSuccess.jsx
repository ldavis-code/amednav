...
const SubscribeSuccess = () => {
    ...
    return (
        <article className="max-w-2xl mx-auto text-center py-12 space-y-8">
            {/* Success Icon */}
            <div className="inline-flex items-center justify-center w-20 h-20 bg-plum-100 rounded-full">
                <CheckCircle size={48} className="text-plum-600" aria-hidden="true" />
            </div>
            ...
            {/* Features Unlocked */}
            <div className="bg-plum-50 border-2 border-plum-200 rounded-2xl p-8">
                <div className="flex items-center justify-center gap-2 mb-6">
                    <Sparkles size={24} className="text-plum-600" />
                    <h2 className="text-xl font-bold text-plum-900">You now have access to:</h2>
                </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Link
                    to="/savings-tracker"
                    className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white hover:bg-slate-50 text-plum-700 border-2 border-plum-200 font-bold rounded-xl transition"
                >
                    Savings Calculator
                </Link>
            </div>
